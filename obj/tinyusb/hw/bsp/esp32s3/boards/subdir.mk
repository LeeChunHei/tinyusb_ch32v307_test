...
C_SRCS += \
../tinyusb/hw/bsp/esp32s3/boards/esp32s3.c 

OBJS += \
./tinyusb/hw/bsp/esp32s3/boards/esp32s3.o 

C_DEPS += \
./tinyusb/hw/bsp/esp32s3/boards/esp32s3.d 


# Each subdirectory must supply rules for building sources it contributes
tinyusb/hw/bsp/esp32s3/boards/%.o: ../tinyusb/hw/bsp/esp32s3/boards/%.c
	@echo 'Building file: $<'
